    ...
    public class DirectTransactionRepository : IDirectTransactionRepository
    {
        ...
        public async Task<bool> DeletedTransactionTableCreate()
        {
            ...
            try
            {
                ...
                SqlConnection sqlConnection = new SqlConnection("Data Source=.;Initial Catalog=sefim2;Persist Security Info=True;User ID=sa;Password=123456a.A;Encrypt=True;Trust Server Certificate=True");
